    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="{{ url('/admin') }}" class="logo-link">
                <img class="logo-img" alt="Logo" src="{{ asset('uploads/settings/logo.png') }}">
                {{-- <span class="logo-text">ECab</span> --}}
            </a>
        </div>
        <!-- logo end -->
        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                            ...
                            <ul class="dropdown-menu-list small-slimscroll-style" data-handle-color="#637283">
                                ...
                                <li>
                                    <a href="javascript:;">
                                        ...
                                        <span class="details">
                                            <span class="notification-icon circle purple-bgcolor box-shadow-1"><i
                        ...
                        <li>
                            <ul class="dropdown-menu-list small-slimscroll-style" data-handle-color="#637283">
                                <li>
                                    <a href="#">
                                        <span class="photo">
                                            <img src="{{ asset('assets/Admin/img/user/user2.jpg') }}"
                                ...
                                <li>
                                    <a href="#">
                                        <span class="photo">
                                            <img src="{{ asset('assets/Admin/img/user/user3.jpg') }}"
                                                class="img-circle" alt=""> </span>
                                        <span class="subject">
                                ...
                                <li>
                                    <a href="#">
                                        <span class="photo">
                                            <img src="{{ asset('assets/Admin/img/user/user1.jpg') }}"
                                                class="img-circle" alt=""> </span>
                                        <span class="subject">
                                ...
                                <li>
                                    <a href="#">
                                        <span class="photo">
                                            <img src="{{ asset('assets/Admin/img/user/user8.jpg') }}"
                                                class="img-circle" alt=""> </span>
                                        <span class="subject">
                                ...
                                <li>
                                    <a href="#">
                                        <span class="photo">
                                            <img src="{{ asset('assets/Admin/img/user/user5.jpg') }}"
                                                class="img-circle" alt=""> </span>
                                        <span class="subject">
                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-bs-toggle="dropdown" data-hover="dropdown"
                        data-close-others="true">
                        <img alt="" class="img-circle " src="{{ asset('uploads/settings/person.png') }}" />
