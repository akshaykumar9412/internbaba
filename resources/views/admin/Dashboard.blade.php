            ...
            <div class="card">
                <div class="panel-body">
                    ...
                    <div class="progressbar-xs progress box-shadow-1">
                        <div class="progress-bar progress-bar-green" role="progressbar" aria-valuenow="65" aria-valuemin="0"
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
            <div class="card">
                <div class="panel-body">
                    ...
                    <div class="progressbar-xs progress box-shadow-1">
                        <div class="progress-bar progress-bar-orange" role="progressbar" aria-valuenow="68"
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
            <div class="card">
                <div class="panel-body">
                    <h3>Users Rating</h3>
                    <div class="progressbar-xs progress box-shadow-1">
                        <div class="progress-bar progress-bar-purple" role="progressbar" aria-valuenow="52"
                            aria-valuemin="0" aria-valuemax="100" style="width: 52%;"></div>
                    </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
            <div class="card">
                <div class="panel-body">
                    <h3>Earning</h3>
                    <div class="progressbar-xs progress box-shadow-1">
                        <div class="progress-bar progress-bar-cyan" role="progressbar" aria-valuenow="56" aria-valuemin="0"
                    ...
                    <div class="row">
                        <div class="noti-information notification-menu">
                            <div class="notification-list mail-list not-list small-slimscroll-style">
                                <a href="javascript:;" class="single-mail"> <span class="icon bg-b-green box-shadow-1">
                                ...
                                <a href="javascript:;" class="single-mail"> <span class="icon bg-b-orange box-shadow-1">
                                        <i class="fa fa-envelope-o"></i>
                                    </span> <span class="text-purple">John Doe</span> Give review for
                                    ride
                                    <span class="notificationtime">
                                        <small>Just Now</small>
                                    </span>
                                </a>
                                <a href="javascript:;" class="single-mail"> <span class="icon bg-b-purple box-shadow-1">
                                ...
                                <a href="javascript:;" class="single-mail"> <span class="icon bg-b-black box-shadow-1">
                                ...
                                <a href="javascript:;" class="single-mail"> <span class="icon bg-b-pink box-shadow-1"> <i
                                ...
                                <a href="javascript:;" class="single-mail"> <span class="icon bg-b-yellow box-shadow-1">
                                        <i class="fa fa-envelope-o"></i>
                                ...
                                <a href="javascript:;" class="single-mail"> <span class="icon bg-success box-shadow-1">
                                        <i class="fa fa-check-square-o"></i>
                                    </span> Success Message
                                    <span class="notificationtime">
                                        <small> 2 Days Ago</small>
                                ...
                                <a href="javascript:;" class="single-mail"> <span class="icon bg-warning box-shadow-1">
                                        <i class="fa fa-warning"></i>
                                ...
                                <a href="javascript:;" class="single-mail"> <span class="icon bg-danger box-shadow-1"> <i
                                            class="fa fa-times"></i>
                        ...
                        <ul class="docListWindow small-slimscroll-style">
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-sm-8">
                                        <div class="prog-avatar">
                                            <img src="{{ asset('assets/Admin/img/user/user1.jpg') }}" alt=""
                                                width="40" height="40">
                                        </div>
                                        <div class="details">
                                            <div class="title">
                            ...
                            <li>
                                <div class="row">
                                    <div class="col-md-8 col-sm-8">
                                        <div class="prog-avatar">
                                            <img src="{{ asset('assets/Admin/img/user/user2.jpg') }}" alt=""
                                                width="40" height="40">
                                        </div>
                                        <div class="details">
                                            <div class="title">
                            ...
                            <li>
                                <div class="row">
                                    <div class="col-md-8 col-sm-8">
                                        <div class="prog-avatar">
                                            <img src="{{ asset('assets/Admin/img/user/user3.jpg') }}" alt=""
                                                width="40" height="40">
                                        </div>
                                        <div class="details">
                                            <div class="title">
                            ...
                            <li>
                                <div class="row">
                                    <div class="col-md-8 col-sm-8">
                                        <div class="prog-avatar">
                                            <img src="{{ asset('assets/Admin/img/user/user4.jpg') }}" alt=""
                                                width="40" height="40">
                                        </div>
                                        <div class="details">
                                            <div class="title">
                            ...
                            <li>
                                <div class="row">
                                    <div class="col-md-8 col-sm-8">
                                        <div class="prog-avatar">
                                            <img src="{{ asset('assets/Admin/img/user/user5.jpg') }}" alt=""
                                                width="40" height="40">
                                        </div>
                                        <div class="details">
                                            <div class="title">
                            ...
                            <li>
                                <div class="row">
                                    <div class="col-md-8 col-sm-8">
                                        <div class="prog-avatar">
                                            <img src="{{ asset('assets/Admin/img/user/user6.jpg') }}" alt=""
                                                width="40" height="40">
                                        </div>
                                        <div class="details">
                                            <div class="title">
        ...
        <div class="col-lg-4 col-md-12 col-sm-12 col-12">
            <div class="card-box">
                <div class="card-head">
                    ...
                    <button id="panel-button1" class="mdl-button mdl-js-button mdl-button--icon pull-right"
                        data-upgraded=",MaterialButton">
                        <i class="material-icons">more_vert</i>
                    </button>
                    <ul class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect"
